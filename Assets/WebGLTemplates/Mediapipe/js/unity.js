...
let resize = () => {
    if (container_parent.clientWidth <= container_parent.clientHeight * 1.65) {
        container_child.style.width = container_parent.clientWidth.toString() + 'px';
        container_child.style.height = (container_parent.clientWidth / 1.65).toString() + 'px';
    } else  if (container_parent.clientWidth >= container_parent.clientHeight * 1.55) {
        container_child.style.width = (container_parent.clientHeight * 1.55).toString() + 'px';
